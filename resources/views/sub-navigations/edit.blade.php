    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Edit Sub Navigation</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            {{--<!-- Modal body -->--}}
            <div class="modal-body">
                <form action="{{ route('sub_navigation_update') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Name:</strong>
                                <input type="hidden" name="nav_id" id="nav_id" class="form-control">
                                <input type="hidden" name="id" id="sub_nav_id" class="form-control">
